  ...
  tabs: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          parameters: [
            ...
            { name: "Quality of Ticket : In SLA Mobile", target: "95%", dailyValues: { 1: "95%", 2: "95.2%", 30: "94.8%" }, mtdAchievement: "95.1%", robotAchievement: "95.5%" },
            { name: "Quality of Ticket : In SLA Fixed", target: "96,5%", dailyValues: { 1: "96.5%", 2: "96.7%", 30: "96.4%" }, mtdAchievement: "96.5%", robotAchievement: "97%" },
            { name: "Close rate tiket Mobile", target: "98%", dailyValues: { 1: "98%", 2: "98.1%", 30: "97.9%" }, mtdAchievement: "98.0%", robotAchievement: "98.5%" },
          ],
        },
      ],
      summaryHighlight: [
        ...
        "Close rate tiket Mobile stabil di 98% selama 3 periode berturut-turut.",
      ...
      monthlyComparison: [
        ...
        { no: "5", parameter: "FCR Mobile Permintaan", definisi: "Persentase interaksi Permintaan pelanggan Mobile selesai di agent", target: "99%", bobot: "4%", nasionalAch: "97.66%", nasionalAchTarget: "98.65%", nasionalScore: "3.95%", bdgAch: "97.91%", bdgScore: "3.96%", smgAch: "97.31%", smgScore: "3.93%" },
        { no: "6", parameter: "FCR Mobile Komplain", definisi: "Persentase interaksi Komplain pelanggan Mobile selesai di agent", target: "66%", bobot: "4%", nasionalAch: "66.91%", nasionalAchTarget: "101.38%", nasionalScore: "4.06%", bdgAch: "68.90%", bdgScore: "4.18%", smgAch: "64.41%", smgScore: "3.90%" },
        { no: "7", parameter: "FCR Fixed Komplain", definisi: "Persentase interaksi Komplain pelanggan Fixed selesai di agent", target: "45%", bobot: "3%", nasionalAch: "39.11%", nasionalAchTarget: "86.92%", nasionalScore: "2.61%", bdgAch: "39.21%", bdgScore: "2.61%", smgAch: "39.09%", smgScore: "2.61%" },
        { no: "8", parameter: "FCR Fixed Komplain Reciprocal", definisi: "Persentase interaksi Komplain Reciprocal selesai di agent", target: "81%", bobot: "4%", nasionalAch: "70.41%", nasionalAchTarget: "86.93%", nasionalScore: "3.48%", bdgAch: "71.05%", bdgScore: "3.51%", smgAch: "70.22%", smgScore: "3.47%" },
        ...
        { no: "2", parameter: "Quality of Ticket : In SLA Mobile", definisi: "In SLA Mobile : Persentase tiket Mobile close in SLA", target: "95%", bobot: "5%", nasionalAch: "93.59%", nasionalAchTarget: "98.52%", nasionalScore: "4.93%", bdgAch: "92.54%", bdgScore: "4.87%", smgAch: "94.76%", smgScore: "4.99%" },
        { no: "3", parameter: "Quality of Ticket : In SLA Fixed", definisi: "In SLA Fixed : Persentase tiket Fixed WSA close in SLA", target: "96.50%", bobot: "10%", nasionalAch: "94.40%", nasionalAchTarget: "97.82%", nasionalScore: "9.78%", bdgAch: "94.13%", bdgScore: "9.75%", smgAch: "94.53%", smgScore: "9.80%" },
        { no: "4", parameter: "Close rate tiket Mobile", definisi: "Close rate tiket Mobile close dibulan M-1", target: "98%", bobot: "10%", nasionalAch: "98.09%", nasionalAchTarget: "100.09%", nasionalScore: "10.01%", bdgAch: "97.60%", bdgScore: "9.96%", smgAch: "98.58%", smgScore: "10.06%" },
      ...
      sections: [
        ...
        },
        {
          ...
          parameters: [
            ...
            { name: "FCR Fixed Komplain Reciprocal", target: "93%", dailyValues: { 1: "92.8%", 2: "93.1%", 15: "93.0%" }, mtdAchievement: "93.0%", robotAchievement: "94%" },
          ],
        },
        {
          name: "Internal Process",
          ...
          parameters: [
            ...
            { name: "Quality of Ticket : In SLA Mobile", target: "93%", dailyValues: { 1: "92.8%", 2: "93.1%", 15: "93.0%" }, mtdAchievement: "93.0%", robotAchievement: "94%" },
            { name: "Quality of Ticket : In SLA Fixed", target: "96,5%", dailyValues: { 1: "96.5%", 2: "96.6%", 15: "96.5%" }, mtdAchievement: "96.5%", robotAchievement: "97%" },
            { name: "Close rate tiket Mobile", target: "98%", dailyValues: { 1: "97.8%", 2: "98.2%", 15: "98.0%" }, mtdAchievement: "98.0%", robotAchievement: "98.5%" },
          ],
        },
      ],
      summaryHighlight: [
        ...
        "Quality of Ticket : In SLA Fixed mencapai hasil optimal 96.5%.",
        "Close rate tiket Mobile di angka 98%, menunjukkan penyelesaian isu yang efisien."
      ],
      monthlyComparison: [
        ...
        { no: "5", parameter: "FCR Mobile Permintaan", definisi: "Persentase interaksi Permintaan pelanggan Mobile selesai di agent", target: "97%", bobot: "4%", nasionalAch: "96.93%", nasionalAchTarget: "99.93%", nasionalScore: "4.00%", bdgAch: "97.59%", bdgScore: "4.02%", smgAch: "96.22%", smgScore: "3.97%" },
        { no: "6", parameter: "FCR Mobile Komplain", definisi: "Persentase interaksi Komplain pelanggan Mobile selesai di agent", target: "69%", bobot: "4%", nasionalAch: "76.65%", nasionalAchTarget: "111.08%", nasionalScore: "4.44%", bdgAch: "76.34%", bdgScore: "4.43%", smgAch: "77.11%", smgScore: "4.47%" },
        { no: "7", parameter: "FCR Fixed Komplain", definisi: "Persentase interaksi Komplain pelanggan Fixed selesai di agent", target: "80%", bobot: "3%", nasionalAch: "76.95%", nasionalAchTarget: "96.19%", nasionalScore: "2.89%", bdgAch: "76.63%", bdgScore: "2.87%", smgAch: "77.37%", smgScore: "2.90%" },
        { no: "8", parameter: "FCR Fixed Komplain Reciprocal", definisi: "Persentase interaksi Komplain Reciprocal selesai di agent", target: "93%", bobot: "4%", nasionalAch: "90.89%", nasionalAchTarget: "97.74%", nasionalScore: "3.91%", bdgAch: "90.20%", bdgScore: "3.88%", smgAch: "91.88%", smgScore: "3.95%" },
        ...
        { no: "3", parameter: "Quality of Ticket : In SLA Mobile", definisi: "In SLA Mobile : Persentase tiket Mobile close in SLA", target: "93%", bobot: "5%", nasionalAch: "92.92%", nasionalAchTarget: "99.91%", nasionalScore: "5.00%", bdgAch: "92.86%", bdgScore: "4.99%", smgAch: "93.00%", smgScore: "5.00%" },
        { no: "4", parameter: "Quality of Ticket : In SLA Fixed", definisi: "In SLA Fixed : Persentase tiket Fixed WSA close in SLA", target: "96.50%", bobot: "10%", nasionalAch: "93.51%", nasionalAchTarget: "96.90%", nasionalScore: "9.69%", bdgAch: "93.17%", bdgScore: "9.65%", smgAch: "93.94%", smgScore: "9.73%" },
        { no: "5", parameter: "Close rate tiket Mobile", definisi: "Close rate tiket Mobile close dibulan M-1", target: "98%", bobot: "10%", nasionalAch: "99.12%", nasionalAchTarget: "101.14%", nasionalScore: "10.11%", bdgAch: "99.07%", bdgScore: "10.11%", smgAch: "99.23%", smgScore: "10.13%" },
