  ...
  tabs: [
    {
      ...
      monthlyComparison: [
        ...
        { no: "6", parameter: "FCR Fixed Komplain", definisi: "Persentase interaksi Komplain pelanggan Fixed selesai di agent", target: "45%", bobot: "3%", nasionalAch: "39.11%", nasionalAchTarget: "86.92%", nasionalScore: "2.61%", bdgAch: "39.21%", bdgScore: "2.61%", smgAch: "39.09%", smgScore: "2.61%" },
        { no: "", parameter: "FCR Fixed Komplain Reciprocal", definisi: "Persentase interaksi Komplain Reciprocal selesai di agent", target: "81%", bobot: "4%", nasionalAch: "70.41%", nasionalAchTarget: "86.93%", nasionalScore: "3.48%", bdgAch: "71.05%", bdgScore: "3.51%", smgAch: "70.22%", smgScore: "3.47%", isSubRow: true },
        ...
        { no: "", parameter: "Quality of Ticket : In SLA Fixed", definisi: "In SLA Fixed : Persentase tiket Fixed WSA close in SLA", target: "96.50%", bobot: "10%", nasionalAch: "94.40%", nasionalAchTarget: "97.82%", nasionalScore: "9.78%", bdgAch: "94.13%", bdgScore: "9.75%", smgAch: "94.53%", smgScore: "9.80%", isSubRow: true },
    ...
    },
    {
      ...
      monthlyComparison: [
        ...
        { no: "6", parameter: "FCR Fixed Komplain", definisi: "Persentase interaksi Komplain pelanggan Fixed selesai di agent", target: "80%", bobot: "3%", nasionalAch: "76.95%", nasionalAchTarget: "96.19%", nasionalScore: "2.89%", bdgAch: "76.63%", bdgScore: "2.87%", smgAch: "77.37%", smgScore: "2.90%" },
        { no: "", parameter: "FCR Fixed Komplain Reciprocal", definisi: "Persentase interaksi Komplain Reciprocal selesai di agent", target: "93%", bobot: "4%", nasionalAch: "90.89%", nasionalAchTarget: "97.74%", nasionalScore: "3.91%", bdgAch: "90.20%", bdgScore: "3.88%", smgAch: "91.88%", smgScore: "3.95%", isSubRow: true },
        ...
        { no: "", parameter: "Quality of Ticket : In SLA Fixed", definisi: "In SLA Fixed : Persentase tiket Fixed WSA close in SLA", target: "96.50%", bobot: "10%", nasionalAch: "93.51%", nasionalAchTarget: "96.90%", nasionalScore: "9.69%", bdgAch: "93.17%", bdgScore: "9.65%", smgAch: "93.94%", smgScore: "9.73%", isSubRow: true },
